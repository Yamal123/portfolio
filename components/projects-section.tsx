  ...
  const projects = [
    {
      ...
      title: language === "zh" ? "兔智星智能助手" : "Tuzhixing Assistant",
      description: language === "zh" ? "基于Dify+GPT-4o的巴西市场智能助手，问答准确率88%" : "Brazil market AI assistant based on Dify+GPT-4o, 88% Q&A accuracy",
      tags: ["Dify", "GPT-4o", "RAG"]
    },
    {
      emoji: "🚚",
      category: language === "zh" ? "企业级应用" : "Enterprise",
      title: language === "zh" ? "极兔AI客服" : "J&T AI Customer Service",
      description: language === "zh" ? "Multi-Agent协作系统，工单处理效率提升40%" : "Multi-Agent collaboration system, 40% efficiency improvement",
    ...
    },
    {
      ...
      description: language === "zh" ? "适配阿联酋、沙特、科威特的复杂物流需求" : "Complex logistics for UAE, Saudi Arabia, Kuwait",
      tags: ["International", "Logistics", "Compliance"]
    },
    {
      emoji: "🌊",
      category: language === "zh" ? "社会公益" : "Social Good",
      title: language === "zh" ? "海好有你" : "Haihao Youyou",
      description: language === "zh" ? "海洋生态治理数字化平台，浙江省共同富裕最佳实践" : "Marine ecosystem digital platform, Zhejiang best practice",
      tags: ["ESG", "Social", "Digital"]
    }
  ]

  return (
    <section id="projects" className={`py-24 relative ${theme === "dark" ? "bg-black" : "bg-white"}`}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
            {language === "zh" ? "Vibe Coding项目" : "Vibe Coding Projects"}
          </h2>
        </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-orange-500/20 to-orange-600/20 flex items-center justify-center relative overflow-hidden">
                <div className="text-6xl transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">{project.emoji}</div>
